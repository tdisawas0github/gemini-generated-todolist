    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 font-inter flex flex-col items-center p-4 transition-colors duration-300 relative">
      ...
      <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-6 transition-colors duration-300 border border-gray-200 dark:border-gray-700 mt-16"> {/* Added mt-16 to push content down from controls */}
        ...
        <form onSubmit={addTodo} className="flex gap-2 mb-6">
          ...
          <button
            type="submit"
            className="px-5 py-3 bg-blue-500 text-white rounded-lg shadow-md hover:bg-blue-600 dark:bg-purple-600 dark:hover:bg-purple-700 transition-all duration-200 font-semibold focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400 dark:focus:ring-purple-400"
          >
            {t.addBtn}
          </button>
        </form>
            ...
            {todos.map(todo => (
              ...
              >
                <span
                  ...
                  className="flex-grow cursor-pointer text-lg font-medium select-none"
                >
                  {todo.text}
                </span>
                <button
                  onClick={() => deleteTodo(todo.id)}
                  className="ml-4 p-2 rounded-full bg-red-500 text-white hover:bg-red-600 transition-all duration-200 shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-400"
